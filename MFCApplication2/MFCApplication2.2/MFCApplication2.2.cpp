...
// MFCApplication2.2.cpp : 定义应用程序的类行为。
//
...
// CMFCApplication22App 构造

CMFCApplication22App::CMFCApplication22App()
{
	// 支持重新启动管理器
	...
	SetAppID(_T("MFCApplication2.2.AppID.NoVersion"));

	// TODO: 在此处添加构造代码，
	// 将所有重要的初始化放置在 InitInstance 中
}

// 唯一的一个 CMFCApplication22App 对象

CMFCApplication22App theApp;


// CMFCApplication22App 初始化
